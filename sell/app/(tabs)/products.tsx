      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity
            ...
            onPress={() => router.push('/bulk-stock' as any)}
            accessibilityLabel="Bulk update stock"
          >
...
const styles = StyleSheet.create({
  ...
  bulkBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center' },
