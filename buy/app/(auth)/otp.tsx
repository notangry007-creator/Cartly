...
export default function OTPScreen() {
  ...
  const { phone, e164 } = useLocalSearchParams<{ phone: string; e164: string }>();
  ...
  return (
    <View
      style={[s.container, { paddingTop: insets.top, paddingBottom: insets.bottom + SPACING.lg }]}
    >
      ...
      <View style={s.content}>
        ...
        <Surface style={s.otpBox} elevation={1}>
          ...
          <Text variant="labelMedium" style={s.otpLabel}>
        ...
        <View style={s.resendRow}>
          <Text variant="bodySmall" style={s.resendTxt}>
            Didn't receive?{' '}
          </Text>
          {countdown > 0 ? (
            <Text variant="bodySmall" style={s.cd}>
              Resend in {countdown}s
            </Text>
          ) : (
            <TouchableOpacity onPress={resend}>
              <Text variant="bodySmall" style={s.rl}>
                Resend OTP
              </Text>
            </TouchableOpacity>
          )}
